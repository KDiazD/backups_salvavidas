                ...
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation">
                            <a type="button" class="btn btn-info" href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab">Recupera Contraceña</a>
                        </li>
                        <li role="presentation">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade in" id="tab2">
                            ...
                            <div class="fcorn-shortcodes">
                                <form action="#" class="form-theme">
                                    ...
                                    <label>Correro</label>
                                    <input type="password" placeholder="Digite el Correo " class="input">
                        ...
                        <div role="tabpanel" class="tab-pane fade in" id="tab3">
                            <form action="#" class="form-theme">
                                <label>Nombre</label>
                                <input type="text" placeholder="Digite el Nombre" class="input">

                                <label>Apellido</label>
                                <input type="text" placeholder="Digite el Apellido" class="input">


                                <label>Correo</label>
                                <input type="text" placeholder="Digite el Correo" class="input">

                                <label>Contraseña</label>
                                <input type="text" placeholder="Digite el Contraseña" class="input">
