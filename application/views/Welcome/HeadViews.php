...
<head>
    ...
    <link href="<?php echo base_url(); ?>Assets/css/theme-responsive.css" rel="stylesheet" media="screen">
    ...
    <!-- Head Libs -->
    <script src="<?php echo base_url(); ?>Assets/js/libs/modernizr.js"></script>
