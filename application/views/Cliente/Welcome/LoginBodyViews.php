                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade in active" id="tab1">
                            <form action="<?php echo base_url()?>Login/Session" method="post" required class="form-theme">
                                ...
                                <input type="password" placeholder="Digite su contraseña" required name="Password" class="input">
                        ...
                        <div role="tabpanel" class="tab-pane fade in" id="tab3">
                            <form action="<?php echo base_url(); ?>Login/Rgistre" required method="post" class="form-theme">
                                ...
                                <input type="password" placeholder="Digite el Contraseña" required name="PassUser" class="input">
