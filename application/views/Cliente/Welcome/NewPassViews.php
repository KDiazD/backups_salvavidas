            ...
            <div class="row user-area">
                ...
                <div class="col-md-12">
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="tab3">
                            <form action="<?php echo base_url()?>Login/Newpass" method="post" class="form-theme">

                                <label>Nueve Contrasña</label>
                                <input type="password" placeholder="Digite el Contraseña" name="NewPassUser" class="input">
                                <label>Repectir Contraseña</label>
                                <input type="password" placeholder="Digite el Contraseña" name="RePassUser" class="input">
